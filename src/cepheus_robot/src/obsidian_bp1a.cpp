...
double ps_x = 0.0, ps_y = 0.0, ps_theta = 0.1, ps_theta_prev = 0.1, rw_position_prev = 0.0; ////////////////////////////////////////////////////////////////////////////////////////////////!!!!!!!!!!!!!!!!!!!!**************************
...
int main(int argc, char** argv) {
	...
	while (ls_position == 0.0000 || le_position == 0.00000) {
	// || ps_theta == 0 || angular_vel_z == 0 
	...
	while (!g_request_shutdown) {
		...
		if (abs(ps_theta_dot - ps_theta_dot_prev) > 0.06)
